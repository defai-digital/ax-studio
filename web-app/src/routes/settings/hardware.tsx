...
function HardwareContent() {
  ...
  const {
    ...
    ? {
        devices: [] as ReturnType<
          typeof useLlamacppDevices.getState
        >['devices'],
        loading: false,
  ...
  // Backend updater
  const { updateState, checkForUpdate, updateBackend, installBackend } =
    useBackendUpdater()
                  ...
                  {!IS_MACOS &&
                    ...
                    (llamacppDevicesLoading ||
                      ...
                      <Card title={t('settings:hardware.gpus')}>
                        {llamacppDevicesLoading ? (
                          <CardItem
                            title={t('settings:hardware.loadingDevices')}
                            actions={<></>}
                          />
                        ) : llamacppDevicesError ? (
                          <CardItem
                  ...
                  {PlatformFeatures[PlatformFeature.LOCAL_INFERENCE] && (
                    <Card title={t('settings:hardware.engineUpdates')}>
                      <CardItem
                        ...
                        description={t(
                          'settings:hardware.checkForBackendUpdatesDesc'
                        )}
                        actions={
