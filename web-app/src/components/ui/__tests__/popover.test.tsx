...
describe('Popover Components', () => {
  ...
  describe('PopoverContent', () => {
    ...
    it('supports all alignment options', async () => {
      ...
      for (const align of alignments) {
        ...
        await waitFor(() => {
          expect(
            screen.getByText(`Content aligned ${align}`)
          ).toBeInTheDocument()
        })
        ...
        await waitFor(() => {
          expect(
            screen.queryByText(`Content aligned ${align}`)
  ...
  describe('Integration Tests', () => {
    it('renders complete popover with all components', async () => {
      ...
      expect(
        screen.getByRole('button', { name: 'Open Complete Popover' })
      ).toBeInTheDocument()
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText('This is a complete popover with all components.')
        ).toBeInTheDocument()
        expect(
    ...
    it('handles keyboard navigation', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByRole('button', { name: 'First Button' })
        ).not.toBeInTheDocument()
      })
    })
    ...
    it('handles click outside to close', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByText('Click outside to close')
        ).not.toBeInTheDocument()
      })
    })
  })
