...
import type { ResearchEntry } from '@/features/research/hooks/useResearchPanel'

let mockEntry: ResearchEntry | null = null
const mockCancelResearch = vi.fn()

vi.mock('@/features/research/hooks/useResearchPanel', () => ({
...
vi.mock('@/features/research/hooks/useResearch', () => ({
  useResearch: () => ({
