import { createChatTransport } from '@/features/chat/lib/chat-transport-factory'
import {
  Chat,
  type UIMessage,
  type UseChatOptions,
...
type CustomChatOptions = Omit<ChatInit<UIMessage>, 'transport'> &
  Pick<UseChatOptions<UIMessage>, 'experimental_throttle' | 'resume'> & {
    ...
    onCostApproval?: (estimate: import('@/features/multi-agent/lib/cost-estimation').CostEstimate) => Promise<boolean>
  }
