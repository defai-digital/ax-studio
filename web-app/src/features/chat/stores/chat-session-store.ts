...
import {
  ...
  applyStatusUpdate,
  destroySession,
} from '@/features/chat/lib/chat-session-controller'
// Re-export types and helpers so existing importers don't break
export type { SessionData, ChatSession } from '@/features/chat/lib/chat-session-types'
export { isSessionBusy } from '@/features/chat/lib/chat-session-controller'
// import { showChatCompletionToast } from "@/components/toasts/chat-completion-toast";

import type { SessionData, ChatSession } from '@/features/chat/lib/chat-session-types'
