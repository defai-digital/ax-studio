...
const PROVIDER_METADATA: Record<
  string,
  { logo?: string; color: string; description: string; title: string }
> = {
  openai: {
    logo: '/images/model-provider/openai.svg',
    color: '#10a37f',
    description: 'GPT-4o, o1, and more',
    title: 'OpenAI',
  },
  anthropic: {
    logo: '/images/model-provider/anthropic.svg',
    color: '#cc7e3a',
    description: 'Claude 3.5, Claude 4',
    title: 'Anthropic',
  },
  gemini: {
    logo: '/images/model-provider/gemini.svg',
    color: '#4285f4',
    description: 'Gemini Pro and Ultra',
    title: 'Gemini',
  },
  groq: {
    logo: '/images/model-provider/groq.svg',
    color: '#f97316',
    description: 'Ultra-fast inference',
    title: 'Groq',
  },
  openrouter: {
    logo: '/images/model-provider/open-router.svg',
    color: '#6366f1',
    description: 'Multi-provider API gateway',
    title: 'OpenRouter',
  },
  azure: {
    logo: '/images/model-provider/azure.svg',
    color: '#0078d4',
    description: 'Azure OpenAI Service',
    title: 'Azure',
  },
  cohere: {
    logo: '/images/model-provider/cohere.svg',
    color: '#39594d',
...
export function getProviderTitle(provider: string): string {
  return (
    PROVIDER_METADATA[provider]?.title ??
