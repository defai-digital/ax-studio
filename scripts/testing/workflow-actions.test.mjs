...
describe('GitHub Actions dependency boundaries', () => {
  ...
  it('independently verifies uploaded Apple, Authenticode, and Minisign signatures', () => {
    ...
    expect(releaseWorkflow).toContain('docs/release/ax-studio.minisign.pub')
    expect(releaseWorkflow).toContain('artifacts/ax-minisign.pub')
    expect(releaseWorkflow).toContain('cmp docs/release/ax-studio.minisign.pub artifacts/ax-minisign.pub')
  ...
  it('requires and verifies the Homebrew stable release path', () => {
    ...
    expect(releaseWorkflow).toContain('minisign -V -p docs/release/ax-studio.minisign.pub')
