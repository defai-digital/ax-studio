...
pub fn teams_dir(app: &AppHandle) -> Result<PathBuf, String> {
...
pub fn list_agent_teams(app: &AppHandle) -> Result<Vec<AgentTeam>, String> {
...
pub fn get_agent_team(app: &AppHandle, team_id: &str) -> Result<AgentTeam, String> {
...
pub fn save_agent_team(app: &AppHandle, team: AgentTeam) -> Result<AgentTeam, String> {
...
pub fn delete_agent_team(app: &AppHandle, team_id: &str) -> Result<(), String> {
    if !is_valid_id(team_id) {
        return Err("Invalid team_id format".to_string());
    }
    let path = teams_dir(app)?.join(format!("{}.json", team_id));
