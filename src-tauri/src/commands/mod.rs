...
macro_rules! desktop_handlers {
    () => {
        tauri::generate_handler![
            ...
            crate::core::filesystem::document_extraction::extract_document_text,
            ...
            crate::core::filesystem::commands::write_blob,
            crate::core::filesystem::commands::unlink_sync,
            crate::core::filesystem::commands::append_file_sync,
            crate::core::filesystem::commands::get_gguf_files,
            ...
            #[cfg(target_os = "macos")]
            crate::core::mlx::commands::mlx_hf_snapshot_dir,
            #[cfg(target_os = "macos")]
            crate::core::mlx::commands::mlx_cleanup_import_artifacts,
            #[cfg(target_os = "macos")]
